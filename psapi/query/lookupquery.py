...
class LookupQuery(Query):
    ...
    @staticmethod
    def make_lookup_query(objects, event_types, meta_object_id=None, \
                          data_object_id=None):
    ...
    def get_message(self, message_type=Message.LS_QUERY_REQUEST):
        return super(LookupQuery, self).get_message(message_type=message_type)
    
    def to_xml(self, message_type=Message.LS_QUERY_REQUEST):
        return super(LookupQuery, self).to_xml(message_type=message_type)
